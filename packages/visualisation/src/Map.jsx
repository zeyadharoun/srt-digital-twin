...
const Map = ({
  ...
  return (
    <DeckGL
      //mapLib={maplibregl}
      mapboxApiAccessToken={"pk.eyJ1IjoiemV5YWRoYXJvdW4iLCJhIjoiY202ejBhZzlqMDBtMDJrczh3N2t0NWFscyJ9.c40bkerUYksJm1hBiqFqcA"} // import.meta.env.VITE_MAPBOX_ACCESS_TOKEN
